...
export const openapiSpec = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "Biglietteria con NFT nominativi su L2 (Base). Regole: prevendita 10% sul primo acquisto (solo TINFT), royalty 1% sul secondario (0,5/0,5), tetto rivendita +5%, max 2 biglietti/evento per identità, export libero con fee 25%."
  },
  ...
  tags: [
    ...
    {name: "mercato", description: "rivendita secondaria (royalty 1%, tetto +5%)"},
  ...
  paths: {
    ...
    "/orders": {
      post: {
        ...
        responses: {"201": {description: "ordine PENDING con breakdown"}, "409": {description: "limite 2/evento o non in vendita"}}
      }
    },
    ...
    "/market/{ticketId}/buy": {
      post: {
        ...
        security: [{bearerAuth: []}],
        responses: {"200": {description: "{ ticket, royalty, paidByBuyerCents }"}, "409": {description: "limite 2/evento"}}
      }
    },
